    ...
    <div class="row h-100 w-100">
      ...
      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6 d-flex align-items-center justify-content-end pr-0 h-100">
        <div class=" w-75 d-flex justify-content-end ">
          <input type="text" name="keyword" v-model="keyword" placeholder="想要找点什么呢" @keyup.enter="search()" class="search_keyword  d-xl-block d-lg-block d-md-none d-sm-none d-none">
          <input type="button" @click="search()" class="search_btn d-xl-block d-lg-block d-md-block d-sm-none d-none">
        </div>
