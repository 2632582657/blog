<template>
  <div class="admin_side border-top bg-primary">
    <ul class="text-center text-white text-xl-left text-lg-left text-md-left text-sm-left">
      <li
        :class="'py-3 px-lg-5 px-xl-5 px-md-5 px-sm-5  cur '+(navActive===i?'active':'')"
      ...
      >
        ...
        <span
          class="ml-2 d-none d-sm-inline-block d-md-inline-block d-lg-inline-block d-xl-inline-block"
          v-text="item.title"
        ></span>
      </li>
    </ul>
